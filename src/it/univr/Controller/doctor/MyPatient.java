...
public class MyPatient implements Initializable {
    ...
    public void viewPrescriptions(ActionEvent event) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../../View/doctor/Prescriptions.fxml"));
    ...
    public void viewReportedSymptoms(ActionEvent event) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../../View/doctor/ViewSymptomsDoctor.fxml"));
            Parent root1 = fxmlLoader.load();
            Stage stage = new Stage();
            stage.initModality(Modality.WINDOW_MODAL);
            // Specifies the owner Window (parent) for new window
