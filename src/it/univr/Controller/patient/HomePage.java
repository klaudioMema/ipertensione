...
import it.univr.Controller.BloodPressure;
...
public class HomePage implements Initializable {
    ...
    private void openBloodPressureWindow(){
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../../View/BloodPressure.fxml"));
    ...
    private void openTakePrescriptionWindow(){
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../../View/patient/Medications.fxml"));
            Parent root1 = fxmlLoader.load();
    ...
    private void openSymptomsWindow(){
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../../View/patient/ViewSymptomsPatient.fxml"));
            Parent root1 = fxmlLoader.load();
